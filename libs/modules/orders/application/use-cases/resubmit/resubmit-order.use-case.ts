...
export interface ResubmitOrderRequest {
  readonly actor: AuthenticatedActor;
  readonly id: OrderId;
}

export interface ResubmitOrderResult {
  readonly order: Order;
  readonly pipelineResult: ApplicationPipelineResult;
}

export interface ResubmitOrderDependencies {
...
const PIPELINE_INCONSISTENCY_MESSAGE =
  'Order resubmit pipeline result is inconsistent';

export class ResubmitOrderUseCase {
  ...
  async execute(request: ResubmitOrderRequest): Promise<ResubmitOrderResult> {
