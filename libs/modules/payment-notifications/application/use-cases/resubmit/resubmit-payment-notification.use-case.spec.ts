...
import {
  ResubmitPaymentNotificationUseCase as BaseResubmitPaymentNotificationUseCase,
  type ResubmitPaymentNotificationRequest,
...
class ResubmitPaymentNotificationUseCase extends BaseResubmitPaymentNotificationUseCase {
  override execute(
    request: Omit<ResubmitPaymentNotificationRequest, 'actor'> & {
